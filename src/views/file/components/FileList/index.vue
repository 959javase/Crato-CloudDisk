<template>
  <div class="file-list-wrapper">
    ...
    <div class="pagination-wrapper">
      <!-- <div class="current-page-count">current:{{ fileList.length }}files</div> -->
      <el-pagination
        background
...
export default {
  ...
  methods: {
     open() {
        this.$alert( 'Crato 目前处于测试期间，暂未开启任何充值通道，请勿相信任何第三方充值，或通过第三方购买账号。同时测试结束时测试期间的用户数据将全部清空，请勿上传重要数据，因测试导致的数据遗失由用户自己负责。','提示', {
